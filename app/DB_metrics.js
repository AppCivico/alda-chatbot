...
module.exports.checkChatbotUser = async (UserID) => {
...
module.exports.addChatbotUser = async (UserID, UserName, ccsID) => {
	let date = new Date();
...
module.exports.updateCcsChatbotUser = async (UserID, UserName, ccsID) => {
	let date = new Date();
	date = await moment(date).format('YYYY-MM-DD HH:mm:ss');
	UserName.replace('undefined', '');
	await sequelize.query(`
